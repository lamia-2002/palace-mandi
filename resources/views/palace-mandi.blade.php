...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('css/palace-mandi.css') }}">
    ...
    <section class="about" id="about">
        <div class="about-box">
            <div class="about-image">
                <img src="{{ asset('assets/images/about_us.jpg') }}" alt="Palace Mandi Interior">
            </div>
        ...
        <div class="swiper menu-swiper" style="padding: 1rem 0.5rem 4rem 0.5rem; margin-top: 2rem;">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="menu-card">
                        <div class="menu-card-img-wrap">
                            <img src="{{ asset('assets/images/hero_mandi.png') }}" alt="Lamb Mandi">
                        </div>
                        <div class="menu-info">
                            <h3>Lamb Mandi</h3>
                ...
                <div class="swiper-slide">
                    <div class="menu-card">
                        <div class="menu-card-img-wrap">
                            <img src="{{ asset('assets/images/grilled_chicken.png') }}" alt="Chicken Mandhi">
                        </div>
                        <div class="menu-info">
                ...
                <div class="swiper-slide">
                    <div class="menu-card">
                        <div class="menu-card-img-wrap">
                            <img src="{{ asset('assets/images/kunafa.png') }}" alt="Kunafa">
                        </div>
                        <div class="menu-info">
                            <h3>Golden Kunafa</h3>
                ...
                <div class="swiper-slide">
                    <div class="menu-card">
                        <div class="menu-card-img-wrap">
                            <img src="{{ asset('assets/images/hero_plate.png') }}" alt="Chicken Madhoodh">
                        </div>
                        <div class="menu-info">
                ...
                <div class="swiper-slide">
                    <div class="menu-card">
                        <div class="menu-card-img-wrap">
                            <img src="{{ asset('assets/images/barbeque_chicken.png') }}" alt="Barbique Chicken">
                        </div>
                        <div class="menu-info">
